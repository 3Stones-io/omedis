defmodule Omedis.Accounts.ActivityTest do
  ...
  describe "create/2" do
    test "tenant owner can create a activity", %{
      owner: owner,
      tenant: tenant,
      group: group,
      project: project
    ...
    test "authorized user can create a activity", %{
      authorized_user: authorized_user,
      tenant: tenant,
      group: group,
      project: project
    ...
    test "unauthorized user cannot create a activity", %{
      user: user,
      tenant: tenant,
      group: group,
      project: project
  ...
  describe "update/2" do
    test "tenant owner can update a activity", %{
      owner: owner,
      tenant: tenant,
      group: group,
      project: project
    ...
    test "authorized user can update a activity", %{
      authorized_user: authorized_user,
      tenant: tenant,
      group: group,
      project: project
    ...
    test "unauthorized user cannot update a activity", %{
      user: user,
      tenant: tenant,
      group: group,
      project: project
  ...
  describe "move_up/2" do
    ...
    test "tenant owner can move a activity up in position", %{
      activity1: activity1,
      activity2: activity2,
      owner: owner,
      tenant: tenant
    ...
    test "authorized user can move a activity up in position", %{
      authorized_user: authorized_user,
      activity1: activity1,
      activity2: activity2,
      tenant: tenant
    ...
    test "unauthorized user cannot move a activity up in position", %{
      activity2: activity2,
      tenant: tenant,
      user: user
    } do
  ...
  describe "move_down/2" do
    ...
    test "tenant owner can move a activity down in position", %{
      activity1: activity1,
      activity2: activity2,
      owner: owner,
      tenant: tenant
    ...
    test "authorized user can move a activity down in position", %{
      authorized_user: authorized_user,
      activity1: activity1,
      activity2: activity2,
      tenant: tenant
    ...
    test "unauthorized user cannot move a activity down in position", %{
      activity2: activity2,
      tenant: tenant,
      user: user
    } do
