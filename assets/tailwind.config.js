  ...
  theme: {
    extend: {
      colors: {
        ...
        "time-tracking-daily-report-header-bg": "rgba(var(--time-tracking-daily-report-header-bg))",
        "time-tracking-daily-report-item-border": "rgba(var(--time-tracking-daily-report-item-border))",
        "time-tracking-daily-report-item-border-last": "rgba(var(--time-tracking-daily-report-item-border-last))",
        "time-tracking-daily-report-activity-txt": "rgba(var(--time-tracking-daily-report-activity-txt))",
        "time-tracking-edit-delete-menu-bg": "rgba(var(--time-tracking-edit-delete-menu-bg))",
        "time-tracking-edit-delete-menu-border": "rgba(var(--time-tracking-edit-delete-menu-border))",
        "time-tracking-edit-delete-menu-txt": "rgba(var(--time-tracking-edit-delete-menu-txt))",
        "time-tracking-entry-delete-confirmation-txt": "rgba(var(--time-tracking-entry-delete-confirmation-txt))",
        "time-tracking-entry-delete-confirmation-undo-btn": "rgba(var(--time-tracking-entry-delete-confirmation-undo-btn))",
      },
      fontFamily: {
